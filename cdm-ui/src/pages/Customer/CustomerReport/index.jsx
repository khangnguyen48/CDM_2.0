...
function CustomerReport() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (title == "" || description == "") {
      setSnackbar({
        children: "Plese describe your problem",
        severity: "error",
      });
      return;
    }
    await cdmApi
      .createCustomerReport(report)
      .then((response) => {
    ...
    <>
      ...
      <div className="flex bg-white dark:bg-slate-800">
        ...
        <div style={{ marginLeft: 40, width: "100vw" }}>
          ...
          <p className="mt-8 xl:mr-2 mr-4 text-black dark:text-white">
          ...
          <div className="flex flex-col xl:ml-8 ml-2">
            <div class="inline-flex items-center">
              ...
              >
                <input
                  ...
                  id="html"
                  onChange={() => handleRadioChange("website")}
                  checked={selectedOption === "website"}
                />
                <span class="absolute text-gray-900 dark:text-white transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
                  <svg
              ...
              <label
                class="mt-px font-light text-gray-700 dark:text-white cursor-pointer select-none"
                htmlFor="html"
              >
                Website Problem
              </label>
            ...
            <div class="inline-flex items-center">
              ...
              <label
                class="mt-px font-light ext-gray-700 dark:text-white cursor-pointer select-none"
                htmlFor="html"
              >
                Service Problem
              </label>
          ...
          <p className="mt-4 xl:mr-2 mr-4 text-black dark:text-white">
          ...
          <textarea
            ...
            rows="5"
            className="bg-white dark:bg-gray-600 p-6 mt-4 mr-2 xl:mr-24 block p-2.5 w-4/5 text-sm text-black rounded-lg border border-gray-200 focus:border-black bg-white"
            placeholder="Write your thoughts here..."
          ></textarea>
          <p className="mt-4 xl:mr-2 mr-4 text-black dark:text-white">
            Attach Image (if neccessary)
          </p>
          ...
          <div className="flex flex-col xl:ml-8 ml-2">
            <div className="flex">
              <Checkbox
                ...
                defaultChecked
              />
              <label className="mt-2.5 text-black dark:text-white" htmlFor="">
                Phone Call
              </label>
            </div>
            <div className="flex">
              <Checkbox className="bg-black dark:bg-transparent" color="blue" />
              <label className="mt-2.5 text-black dark:text-white" htmlFor="">
                Text Message
              </label>
            </div>
          ...
          <button
            ...
            class="mt-2 mb-64 bg-black dark:bg-blue-500 hover:bg-gray-700 dark:hover:bg-blue-700  text-white font-bold py-2 px-4 rounded text-center mr-2"
          >
            Submit
          </button>
        </div>
